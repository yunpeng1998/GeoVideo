...
try:
    ...
    _import_structure["pipeline_cogvideoxdepth"] = ["CogVideoXDepthPipeline"]
    ...
    _import_structure["pipeline_cogvideox_image2videodepth"] = ["CogVideoXImageToVideoDepthPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_cogvideoxdepth import CogVideoXDepthPipeline
        ...
        from .pipeline_cogvideox_image2videodepth import CogVideoXImageToVideoDepthPipeline
